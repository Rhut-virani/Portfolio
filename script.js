    ...
    () => {
        ...
        swing = () => {
            ...
            var st = new TimelineMax({ paused: true })
                ...
                .call(removeClass)
                .staggerFrom('.contact > span', 0.3, {
                    yPercent: '100',
                    ease: Back.easeOut.config(1.7),
                    opacity: 0,
                    rotation: '270deg',
                }, 0.1, '-=0.5')
                .staggerFrom('.skills > span', 0.3, {
                    yPercent: '-100',
                    ease: Back.easeOut.config(1.7),
                    opacity: 0,
                    rotation: '270deg',
                }, 0.1, '-=0.5')
                .staggerFrom('.about > span', 0.3, {
                    yPercent: '100',
                    ease: Back.easeOut.config(1.7),
                    opacity: 0,
                    rotation: '270deg',
        ...
        function bannerInfinite() {
            ...
            var btInfinite = new TimelineMax({ repeat: -1, repeatDelay: 0 })
                ...
                .to('.mainpage-text3', 0.5, { text: { value: ' ' } }, '+=0.5')
                .to('.mainpage-text3', 3, { text: { value: 'Former Public Health Dentist' } })
                .to('.mainpage-text3', 0.5, { text: { value: ' ' } }, '+=0.5')
        ...
        scrolling = (e) => {
            ...
            if (e.originalEvent.deltaY > 0) {
                const
                    sectionIn = $('.home.active').next($home).length === 0 ? $('.home.active').prevAll($home).last() : $('.home.active').next($home),
            ...
            } else if (e.originalEvent.deltaY < 0) { // scroll up if the deltaY value is negative
                const
                    sectionIn = $('.home.active').prev($home).length === 0 ? $('.home.active').nextAll($home).last() : $('.home.active').prev($home),
                    sectionfade = $('.home.active'),
                    headingIn = $(sectionIn).children().children('.heading'),
                    headingfade = $('.heading.active'),
        ...
        function slideshowbutton(j) {
            const nextslide = $(`.pi${j}-div.active`).next(`.pi${j}-div`).length === 0 ? $(`.pi${j}-div.active`).prevAll(`.pi${j}-div`).last() : $(`.pi${j}-div.active`).next(`.pi${j}-div`);
        ...
        var tsp = new TimelineMax({ paused: true })
            ...
            .staggerFromTo('.skillName3', 0.3, { yPercent: '-40', autoAlpha: 0 }, { yPercent: '0', autoAlpha: 1 }, 0.05)
            .staggerTo('.skillName3', 0.3, { yPercent: '40', autoAlpha: 0 }, 0.05)
            .staggerFromTo('.skillName4', 0.3, { yPercent: '-40', autoAlpha: 0 }, { yPercent: '0', autoAlpha: 1 }, 0.05);
        ...
        gets2Timeline = () => {
            ...
            s2
                ...
                .fromTo('.css4', 0.25, { fontWeight: '200' }, {
        ...
        gets4Timeline = () => {
            ...
            s4
                ...
                .set('.cssh2', { text: { value: ' import  <span class="reacth1">  React, { Component }  </span>  from  <span class="reacth1">  "react" </span>; <br>  import  <span class="reacth1">  SkillsContent </span> from <span class="reacth1">" ./SkillsContent " </span>; ' }, ease: Power1.easeOut })
                .to('.cssh2', 0.5, { autoAlpha: 1 })
                .set('.css1, .css2 ,.css3 ,.css4', { autoAlpha: 0 })
                .set('.css1, .css2, .css3, .css4', { text: '   <br>', ease: Power1.easeIn }, '-=1')
                .set('.css1', {
                    text: { value: ' render() { <br>  return ( <br> <span class="react2"> < div className = "skillsContentGrid" > </span> <br> ' },
                    ease: Power1.easeIn,
                })
                ...
                .set('.css2', { text: { value: ' <span class="react2"> <br> < / div > </span> <br>' }, ease: Power1.easeIn })
                .to('.css2', 0.5, { autoAlpha: 1 })
                .set('.css3', { text: { value: ' <span class="react2"> )  </span> <br>' }, ease: Power1.easeIn })
